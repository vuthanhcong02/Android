...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<HistoryQuiz> getAllHistory(int user_Id_isLogin) {
        ...
        String query = "SELECT *," +
                ...
                "WHERE " + Table.HistoryQuizTable.TABLE_NAME + "." + Table.HistoryQuizTable.COLUMN_USER_ID + " = " + user_Id_isLogin + " " +
